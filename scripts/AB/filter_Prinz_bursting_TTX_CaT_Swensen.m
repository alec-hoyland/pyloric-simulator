...
% initial conditions are standard
...
if ~exist('/home/marder/code/pyloric-simulator/data/data_Prinz_bursting_TTX_CaT.mat','file')
...
if ~exist('/home/marder/code/pyloric-simulator/data/data_Prinz_bursting_TTX_CaT_nosc.mat','file')
...
if ~exist('/home/marder/code/pyloric-simulator/data/data_Prinz_bursting_TTX_CaT_nosc_gMI_Swensen.mat','file')
  ...
  params        = all_params;
  % save data
  save('/home/marder/code/pyloric-simulator/data/data_Prinz_bursting_TTX_CaT_nosc_gMI_Swensen.mat','volt_peaks','volt_troughs','burst_freq','params')
