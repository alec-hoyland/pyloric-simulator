...
function [C, cost_vector, metrics_vector] = network_simulation_function_AB_2c(x)

% set conductances for auxiliary compartments
for ii = 1:3
	gbars = x.getConductances(ii);
	x.setConductances(3+ii,gbars(2:end));
end
