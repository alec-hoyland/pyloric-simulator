...
% load data
if ~exist('~/code/pyloric-simulator/data/thesis/data_plot_network_ABLP.mat')
	allfiles = dir('data_optim_network_ABLP*.mat');
	...
	% save data
	save('~/code/pyloric-simulator/data/thesis/data_plot_network_ABLP.mat', ...
		'V', 'burst_freq', 'duty_cycle', 'nSpikes', 'min_slow_wave', 'max_slow_wave', ...
		'params','parameter_names','nModels');
else
	load('~/code/pyloric-simulator/data/thesis/data_plot_network_ABLP.mat')
end
